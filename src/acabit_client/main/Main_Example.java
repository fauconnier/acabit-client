...
import acabit_client.core.ACABITClient;
...
public class Main_Example {
	...
	public static void main(String[] args) throws UnknownHostException, IOException, InterruptedException {
		...
		String test4 = readFile("test.txt");
    
    
		
		/* Analysing a syntactic structure*/
		Structure structure_test = talismane_client.analyse(test4,false);
		ArrayList<Term> terms = acabit_client.analyse(structure_test, true);
